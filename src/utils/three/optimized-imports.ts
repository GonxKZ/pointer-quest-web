...
export const getStandardMaterial = (options: any = {}): MeshStandardMaterial => {
...
export const getBasicMaterial = (options: any = {}): MeshBasicMaterial => {
  const key = JSON.stringify(options);
  if (!materialCache.has(key)) {
...
export const getLineMaterial = (options: any = {}): LineBasicMaterial => {
  const key = JSON.stringify(options);
  if (!materialCache.has(key)) {
